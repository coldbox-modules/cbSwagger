	...
	function run(){
		describe( "Tests core RouteParser Methods", function() {
			...
			it( "Tests the ability to parse convention path response definition files", function(){
				...
				fileWrite( variables.samplesPath & "/responses/handlers.api.v1.Users.add.json", serializeJSON( { "success" : false } ) );
				fileWrite( variables.samplesPath & "/responses/handlers.api.v1.Users.add.201.json", serializeJSON( { "id" : createUUID(), "success" : true } ) );
			...
			it( "Tests the ability to parse convention path requestBody files", function(){
				...
				fileWrite( variables.samplesPath & "/responseBody/handlers.api.v1.Users.add.json", serializeJSON( { "firstName" : "Luis", "lastName" : "Majano" } ) );
			...
			it( "Tests the ability to parse convention path parameter files", function(){
				...
				fileWrite( variables.samplesPath & "/parameters/handlers.api.v1.Users.add.json", serializeJSON( parameters ) );
